@echo off
REM STEP to OBJ Converter - Batch Wrapper
REM Usage: convert_to_obj.bat input.step [output.obj]

setlocal enabledelayedexpansion

set "SCRIPT_DIR=%~dp0"
set "PYTHON_SCRIPT=%SCRIPT_DIR%convert_to_obj.py"
...
if "%~1"=="" (
    echo Usage: %~nx0 input.step [output.obj]
    exit /b 1
)

...
template_designasm C:\PTC_Data\templates\inlbs_asm_design_abs.asm
template_new_ecadasm $PRO_DIRECTORY\templates\inlbs_ecad_asm_abs.asm
template_drawing C:\PTC_Data\templates\amf_a_drawing.drw
template_sheetmetalpart C:\PTC_Data\templates\inlbs_part_sheetmetal_abs.prt
template_solidpart C:\PTC_Data\templates\inlbs_part_solid_abs.prt
...
mapkey(continued) `D:\\PDM_Vault\\CADData\\ParameterUpdate\\param.txt`;\
...
mapkey(continued) ~ Command `ProCmdMdlTreeSaveAsText` ;\
mapkey(continued) ~ Update `inputname` `InpName` `D:\\PDM_Vault\\CADData\\BOM\\BOM.txt`;\
mapkey(continued) ~ Activate `inputname` `okbutton`;

mapkey expfullbom @MAPKEY_LABELExport Full mBOM;\
mapkey(continued) ~ Activate `main_dlg_cur` `FilterPb`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `general_layout`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `geom_body_lay`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `material_lay`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `cabling_layout`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `mechanism`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `mold`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `mfg`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `piping_layout`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `mechanica`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;~ Activate `mdl_filter` `ok_btn`;\
mapkey(continued) ~ Activate `main_dlg_cur` `ExpandAllPb`;~ Command `ProCmdMdlTreeSaveAsText` ;\
mapkey(continued) ~ Update `inputname` `InpName` `D:\\PDM_Vault\\CADData\\BOM\\MLBOM.txt`;\
mapkey(continued) ~ Activate `inputname` `okbutton`;~ Activate `main_dlg_cur` `FilterPb`;\
mapkey(continued) ~ Activate `mdl_filter` `reset_btn`;~ Activate `mdl_filter` `ok_btn`;\
...
mapkey tsbom @MAPKEY_LABELSend BOM to Server;\
mapkey(continued) ~ Command `ProCmdMdlTreeSaveAsText` ;\
mapkey(continued) ~ Update `inputname` `InpName` `C:\\PDM-Upload\\Test\\BOM.txt`;\
mapkey(continued) ~ Activate `inputname` `okbutton`;

mapkey tparam @MAPKEY_LABELSend Param to Server;\
mapkey(continued) ~ Command `ProCmdMdlTreeSaveAsText` ;\
mapkey(continued) ~ Update `inputname` `InpName` \
mapkey(continued) `C:\\PDM-Upload\\Test\\param.txt`;\
mapkey(continued) ~ Activate `inputname` `okbutton`;~ Command `ProCmdModelSave` ;\
mapkey(continued) ~ Activate `storage_conflicts` `OK_PushButton`;

mapkey tmbom @MAPKEY_LABELExport Full tmBOM;\
mapkey(continued) ~ Activate `main_dlg_cur` `FilterPb`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `core_feat_layout`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `general_layout`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `geom_body_lay`;\
...
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;\
mapkey(continued) ~ Select `mdl_filter` `Tab` 1 `mechanica`;\
mapkey(continued) ~ Activate `mdl_filter` `unselect_all_btn`;~ Activate `mdl_filter` `apply`;\
mapkey(continued) ~ Activate `mdl_filter` `ok_btn`;~ Activate `main_dlg_cur` `ExpandAllPb`;\
mapkey(continued) ~ Command `ProCmdMdlTreeSaveAsText` ;\
mapkey(continued) ~ Update `inputname` `InpName` `C:\\PDM-Upload\\Test\\MLBOM.txt`;\
mapkey(continued) ~ Activate `inputname` `okbutton`;
...
mapkey map @MAPKEY_LABELOpen Mapkey Dialog;\
mapkey(continued) ~ Trigger `search_panel_list_of_main_dlg_cur` `search_panel_list` `` \
mapkey(continued) `Not_in_rbn_group`;\
mapkey(continued) ~ Trigger `search_panel_list_of_main_dlg_cur` `search_panel_list` \
mapkey(continued) `ProCmdUtilMacros`;\
mapkey(continued) ~ Select `search_panel_list_of_main_dlg_cur` `search_panel_list` 1 \
mapkey(continued) `ProCmdUtilMacros`;~ Command `ProCmdUtilMacros` ;\
mapkey(continued) ~ Trigger `search_panel_list_of_main_dlg_cur` `search_panel_list` ``;

mapkey ss @MAPKEY_LABELSave to Working Dir;~ Command `ProCmdModelSave` ;\
mapkey(continued) ~ Activate `file_saveas` `Current Dir`;~ Activate `file_saveas` `OK`;\
mapkey(continued) ~ Activate `storage_conflicts` `OK_PushButton`;

mapkey d1 @MAPKEY_LABELDrawing View 1;\
mapkey(continued) ~ Select `main_dlg_cur` \
mapkey(continued) `igToolbar_AncestorIGT_IGT_GRP_inh407984315.proe_win:casc340798662`;\
mapkey(continued) ~ Close `main_dlg_cur` \
mapkey(continued) `igToolbar_AncestorIGT_IGT_GRP_inh407984315.proe_win:casc340798662`;\
mapkey(continued) ~ Command `ProCmdViewOrient` ;~ Input `orient` `NameVw_IP` `d`;\
mapkey(continued) ~ Input `orient` `NameVw_IP` `dv`;~ Input `orient` `NameVw_IP` `dv1`;\
mapkey(continued) ~ Update `orient` `NameVw_IP` `dv1`;~ Activate `orient` `NameVw_PB_Save`;\
mapkey(continued) ~ Activate `orient` `OkPB`;

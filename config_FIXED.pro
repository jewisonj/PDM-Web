...
http://localhost:8083/workspace.html
...
mapkey(continued) ~ Update `inputname` `InpName` `C:\\PDM-Upload\\param.txt`;\
...
mapkey(continued) ~ Command `ProCmdMdlTreeSaveAsText` ;\
mapkey(continued) ~ Update `inputname` `InpName` `C:\\PDM-Upload\\BOM.txt`;\
...
mapkey(continued) ~ Update `inputname` `InpName` `C:\\PDM-Upload\\MLBOM.txt`;\
...
mapkey(continued) ~ Open `file_open` `Ph_path.Path`;\
mapkey(continued) ~ Close `file_open` `Ph_path.Path`;\
mapkey(continued) ~ Select `file_open` `Ph_path.Path` 1 `C:`;\
mapkey(continued) ~ Select `file_open` `Ph_list.Filelist` 1 `PTC_Data`;\
mapkey(continued) ~ Activate `file_open` `Ph_list.Filelist` 1 `PTC_Data`;\
...
mapkey(continued) ~ Activate `file_saveas` `computer_pb`;\
mapkey(continued) ~ Select `file_saveas` `ph_list.Filelist` 1 `c:`;\
mapkey(continued) ~ Activate `file_saveas` `ph_list.Filelist` 1 `c:`;\
mapkey(continued) ~ Select `file_saveas` `ph_list.Filelist` 1 `PDM-Upload`;\
mapkey(continued) ~ Activate `file_saveas` `ph_list.Filelist` 1 `PDM-Upload`;\
